  ...
  L.BeautifyIcon = {
    Icon: L.Icon.extend({
      ...
      applyDefaults: function (options) {
        if (options) {
          ...
          if (!options.innerIconAnchor) {
            ...
            if (
              options.iconShape === "circle" ||
              options.iconShape === "marker"
            ) {
              if (
                options.iconShape === "circle" &&
                ...
                // marker with icon
                options.innerIconAnchor =
                  defaults.innerIconAnchor[options.iconShape];
              }
            }
          }
        }
      ...
      createIcon: function () {
        ...
        iconDiv.innerHTML = !options.html
          ? this.createIconInnerHtml()
          : options.html;
      ...
      createIconInnerHtml: function () {
        ...
        if (options.isAlphaNumericIcon) {
          return (
            '<div style="' + innerIconStyle + '">' + options.text + "</div>"
          );
        }
